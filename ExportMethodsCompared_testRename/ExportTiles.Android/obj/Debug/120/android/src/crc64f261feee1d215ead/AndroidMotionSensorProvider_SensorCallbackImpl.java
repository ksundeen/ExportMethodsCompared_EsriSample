package crc64f261feee1d215ead;


public class AndroidMotionSensorProvider_SensorCallbackImpl
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.Location.AndroidMotionSensorProvider+SensorCallbackImpl, Esri.ArcGISRuntime", AndroidMotionSensorProvider_SensorCallbackImpl.class, __md_methods);
	}


	public AndroidMotionSensorProvider_SensorCallbackImpl ()
	{
		super ();
		if (getClass () == AndroidMotionSensorProvider_SensorCallbackImpl.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.Location.AndroidMotionSensorProvider+SensorCallbackImpl, Esri.ArcGISRuntime", "", this, new java.lang.Object[] {  });
	}
