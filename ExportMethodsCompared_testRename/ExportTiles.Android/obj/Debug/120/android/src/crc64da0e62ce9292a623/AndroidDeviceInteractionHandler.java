...
public class AndroidDeviceInteractionHandler
	extends crc64da0e62ce9292a623.UserInteractionHandler
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime.Android", AndroidDeviceInteractionHandler.class, __md_methods);
	}
	...
	public AndroidDeviceInteractionHandler ()
	{
		...
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime.Android", "", this, new java.lang.Object[] {  });
	}

	public AndroidDeviceInteractionHandler (crc64ed7a4a679bf6b924.GeoView p0)
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime.Android", "Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime.Android", this, new java.lang.Object[] { p0 });
	}
